...
export default {
    ...
    "properties": {
                ...
                "anyOf": [
                    ...
                    },
                    {
                        "properties": {
                            ...
                            "id": {
                                "description": "A unique identifier used to target this rack in orders and in the `gunboatSquadrons` property.",
                                "type": "string"
                            }
                        },
                        "required": ["name", "id"]
        ...
        "gunboatSquadrons": {
            "description": "Gunboat squadrons carried on gunboat racks. Each rack may have at most one squadron.",
            "type": "array",
            "items": {
                "type": "object",
                "properties": {
                    "rack": {
                        "description": "Must match a gunboatRack id. Omitted for FTL squadrons that cannot use racks.",
                        "type": "string"
                    },
                    "id": {
                        "description": "Stable id for squadrons without a rack (e.g. FTL). Used by runtime overlays.",
                        "type": "string"
                    },
                    "mods": {
                        "type": "array",
