...
export class MineLayer extends System {
    ...
    individualMine(): ISystemSVG {
        const id = this.ship.hashseed === undefined ? `mineIndividual` : fnv.hash(`mineIndividual`).hex();
        return {
            id,
    ...
    glyph() {
        ...
        switch (capacity) {
            case 2:
                id = this.ship.hashseed === undefined ? `mineLayer2` : fnv.hash(`mineLayer2`).hex();
                return {
                    id,
            ...
            case 3:
                id = this.ship.hashseed === undefined ? `mineLayer3` : fnv.hash(`mineLayer3`).hex();
                return {
                    id,
            ...
            case 4:
                id = this.ship.hashseed === undefined ? `mineLayer4` : fnv.hash(`mineLayer4`).hex();
                return {
                    id,
            ...
            case 5:
                id = this.ship.hashseed === undefined ? `mineLayer5` : fnv.hash(`mineLayer5`).hex();
                return {
                    id,
            ...
            case 6:
                id = this.ship.hashseed === undefined ? `mineLayer6` : fnv.hash(`mineLayer6`).hex();
                return {
                    id,
            ...
            case 7:
                id = this.ship.hashseed === undefined ? `mineLayer7` : fnv.hash(`mineLayer7`).hex();
                return {
                    id,
            ...
            case 8:
                id = this.ship.hashseed === undefined ? `mineLayer8` : fnv.hash(`mineLayer8`).hex();
                return {
                    id,
            ...
            case 9:
                id = this.ship.hashseed === undefined ? `mineLayer9` : fnv.hash(`mineLayer9`).hex();
                return {
                    id,
