    ...
    mass() {
        if (this.ship.mass !== undefined) {
            if (this.advanced && this.area) {
                return Math.round(this.ship.mass * 0.3 * this.level);
            } else if (this.advanced) {
                return Math.round(this.ship.mass * 0.075 * this.level);
            } else if (this.area) {
                return Math.round(this.ship.mass * 0.2 * this.level);
            } else {
                return Math.round(this.ship.mass * 0.05 * this.level);
            }
        }
        return NaN;
    }
