...
export class SpinalPlasma extends System {
    ...
    glyph() {
        if (this.range === "short") {
            ...
            const id = this.ship.hashseed === undefined ? `spinalPlasmaL` : fnv.hash(`spinalPlasmaL`).hex();
            return {
                id,
