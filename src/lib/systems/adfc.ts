...
export class Adfc extends System {
    ...
    glyph() {
        if (this.advanced) {
            ...
            return {
                id,
                svg: `<symbol id="${id}" viewBox="248 48 464 464"><g><rect x="257" y="57" fill="white" stroke="#000000" stroke-width="15.0325" stroke-miterlimit="10" width="446" height="446"/><polygon points="480,280 257,57 480,58.8 703,57"/><polygon points="480,280 257,503 480,501.2 703,503"/></g></symbol>`,
                height: 1,
                width: 1,
            };
        }
