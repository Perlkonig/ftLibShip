    ...
    glyph() {
        ...
        switch (this.type) {
            case "cargo":
                id =
                    this.ship.hashseed === undefined
                        ? `bayCargo${this.capacity}`
                        : fnv.hash(`bayCargo${this.capacity}`).hex();
                return {
                    id,
            ...
            case "troop":
                id =
                    this.ship.hashseed === undefined
                        ? `bayTroop${this.capacity}`
                        : fnv.hash(`bayTroop${this.capacity}`).hex();
                return {
                    id,
            ...
            case "passenger":
                id =
                    this.ship.hashseed === undefined
                        ? `bayPassenger${this.capacity}`
                        : fnv.hash(`bayPassenger${this.capacity}`).hex();
                return {
                    id,
