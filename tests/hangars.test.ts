...
const minimalHangarShip = `{"hull":{"points":15,"rows":4,"stealth":"0","streamlining":"none"},"armour":[],"systems":[{"name":"drive","thrust":2,"id":"drv1"},{"name":"ftl","id":"ftl1"},{"name":"hangar","id":"bayA"},{"name":"hangar","id":"bayB"}],"weapons":[],"ordnance":[],"fighters":[{"type":"standard","hangar":"bayA"}],"mass":50,"points":118,"cpv":128,"name":"Test"}`;
