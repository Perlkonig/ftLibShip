...
describe("Flawed designs", () => {
    ...
    it("Correctly applied", () => {
        ...
        expect(results.points).to.equal(760);
        expect(results.cpv).to.equal(903);
    });
});
